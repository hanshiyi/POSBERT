...
BERT_START_DOCSTRING = r"""    The BERT model was proposed in
    ...
    Parameters:
        config (:class:`~glue_data_process.BertConfig`): Model configuration class with all the parameters of the model.
            Initializing with a config file does not load the weights associated with the model, only the configuration.
            Check out the :meth:`~glue_data_process.PreTrainedModel.from_pretrained` method to load the model weights.
"""
...
BERT_INPUTS_DOCSTRING = r"""
    Inputs:
        **input_ids**: ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            ...
            Indices can be obtained using :class:`glue_data_process.BertTokenizer`.
            See :func:`glue_data_process.PreTrainedTokenizer.encode` and
            :func:`glue_data_process.PreTrainedTokenizer.convert_tokens_to_ids` for details.
